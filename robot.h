...
const String MQTT_ID = "disco-ball-001"; // ID for this client when connecting to MQTT
...
const String MQTT_TOPIC[MQTT_TOPIC_COUNT] = {"disco-ball"}; // The topic name you wish to listen for
